<template>
   <div class='vicky-slider-group'>
    <div
      class="vicky-slider-bar"
      ref="sliderBar"
      :value="currentValue"
    ></div>
    <button
      class="vicky-slider-btn"
      ref="sliderBtn"
      draggable="true"
      @touchstart="onButtonDown"
    ></button>
    <div class="vicky-slider-mask" ref="sliderMask"></div>
    <span
      :show="messageIsShow"
      ref="sliderMessage"
      class="vicky-slider-message"
    ></span>
   </div>
</template>
